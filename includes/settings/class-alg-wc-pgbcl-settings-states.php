		...
		foreach ( $gateways as $key => $gateway ) {
			$settings = array_merge( $settings, array(
				array(
					...
					'desc'              => (
						__( 'Base country states only.', 'payment-gateways-by-customer-location-for-woocommerce' ) .
						'<br>' .
						(
				...
				array(
					...
					'custom_attributes' => array_merge(
						array( 'data-placeholder' => __( 'Select states', 'payment-gateways-by-customer-location-for-woocommerce' ) ),
						(
							! in_array( $key, array( 'bacs', 'cheque', 'paypal', 'cod' ) ) ?
							apply_filters(
								'alg_wc_gateways_by_location_settings',
